export default class DormScene extends Phaser.Scene {
  constructor ()
  {
    super({key: 'Dorm'});
    Phaser.Scene.call(this, 'DormScene');
  }
  ...
  preload()
  {
    ...
    this.load.tilemapTiledJSON("dormmap", "/assets/dorm.json");
  ...
  {
    // Make the this.Map
    this.Map = this.make.tilemap({ key: "dormmap" });
