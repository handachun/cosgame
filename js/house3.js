...
export default class House3Scene extends Phaser.Scene {
  constructor ()
  {
    super({key: 'House3'});
    Phaser.Scene.call(this, 'House3Scene');
  ...
  HandleQuestion()
  {
    ...
    .text(50, 25, "What defines the variable scope?", {
      font: "16px monospace",
      fill: "#000000",
      padding: { x: 5, y: 5 },
  ...
  preload()
  {
    ...
    this.load.image("statics_tiles", "/iwgame/assets/static.png");
    this.load.image("basics", "/iwgame/assets/basics.png");

    this.load.tilemapTiledJSON("house3map", "/iwgame/assets/house3.json");

    this.load.image("bezos", "/iwgame/assets/bezos.png");
  }

  create()
  {
    // Make the this.Map
    this.Map = this.make.tilemap({ key: "house3map" });
    ...
    this.Opponent = this.physics.add.sprite(this.OpponentPoint.x, this.OpponentPoint.y, 'bezos').setSize(16, 16).setOffset(0,0).setImmovable(true);
