...
export default class House1Scene extends Phaser.Scene {
  ...
  {
    super({key: 'House1'});
    Phaser.Scene.call(this, 'House1Scene');
  }
  ...
  HandleQuestion()
  {
    ...
    .text(50, 25, "What is the data type used to compute the factorial of 20?", {
      font: "16px monospace",
      fill: "#000000",
      padding: { x: 5, y: 5 },
  ...
  preload()
  {
    ...
    this.load.tilemapTiledJSON("house1map", "/iwgame/assets/house1.json");

    this.load.image("cerf", "/iwgame/assets/cerf.png");
  }

  create()
  {
    // Make the this.Map
    this.Map = this.make.tilemap({ key: "house1map" });
    ...
    this.Opponent = this.physics.add.sprite(this.OpponentPoint.x, this.OpponentPoint.y, 'cerf').setSize(16, 16).setOffset(0,0).setImmovable(true);
